...
extension KeyCommand {
    ...
    public enum Key {
        ...
        /// Runs a check against all the possible values of `Key`, and if
        /// a case is found for which `predicate` evaluates to `true`,
        ...
        /// Runs a check against all the possible values of `Key`, and if
        /// a case is found whose key equivalent matches the given string,
        /// creates a value initialized to that case.
